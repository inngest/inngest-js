...
export namespace Middleware {
  ...
  export type StepType = OpenStringUnion<
    ...
    | "step.sandbox.get"
    | "step.sandbox.list"
    | "step.sandbox.process.get"
    | "step.sandbox.process.list"
    | "step.sandbox.process.output"
    | "step.sandbox.process.signal"
    | "step.sandbox.process.start"
    | "step.sandbox.process.wait"
    | "invoke"
    | "realtime.publish"
    | "run"
    | "sendEvent"
