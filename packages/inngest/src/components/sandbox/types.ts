...
export interface SandboxProcess {
  ...
  readonly startedAt?: string;
  readonly endedAt?: string;
  refresh(): Promise<SandboxProcess | null>;
...
export interface DurableSandbox {
  ...
  readonly processes: {
    ...
    list(idOrOptions: StepOptionsOrId): Promise<DurableSandboxProcess[]>;
    get(
      idOrOptions: StepOptionsOrId,
      processId: string,
    ): Promise<DurableSandboxProcess | null>;
  };
  refresh(idOrOptions: StepOptionsOrId): Promise<DurableSandbox | null>;
...
export interface DurableSandboxProcess {
  ...
  readonly startedAt?: string;
  readonly endedAt?: string;
  refresh(idOrOptions: StepOptionsOrId): Promise<DurableSandboxProcess | null>;
  signal(
    idOrOptions: StepOptionsOrId,
