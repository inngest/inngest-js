# `inngest/ci`: architecture

How CI is put together, for working on it. [README.md](./README.md) is the
user-facing documentation; [NOTES.md](./NOTES.md) records what was verified and
