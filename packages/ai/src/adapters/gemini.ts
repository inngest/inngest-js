...
export namespace GeminiAiAdapter {
  ...
  export interface TextPart {
    ...
    thought?: boolean;
    /**
     * The signature of the thought block.
     * * Required for "Thinking" models (e.g., Gemini 2.0 Flash Thinking) to verify 
     * that the thought content was generated by the model in previous turns.
     */
